          ...
          <div className="rounded-2xl border border-[var(--color-border)] bg-[var(--color-card)] p-6">
            ...
            <form onSubmit={onPasswordSubmit} className="space-y-3">
              ...
              <button
                ...
                className="pressable inline-flex min-h-[44px] w-full items-center justify-center gap-1.5 rounded-md bg-[var(--color-foreground)] px-3 py-2.5 text-sm font-medium text-[var(--color-background)] disabled:opacity-50"
              >
