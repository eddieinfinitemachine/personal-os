...
export default async function manifest(): Promise<MetadataRoute.Manifest> {
  ...
  return {
    ...
    theme_color: "#eaedf4",
    // Android / desktop Chrome: the installed app shows up in the share sheet
    // and drops whatever was shared onto the mood board. (iOS ignores this;
    // there the "Save to Board" Shortcut does the same job.)
    share_target: {
      action: "/api/board/share",
      method: "POST",
