...
export async function POST() {
  ...
  await prisma.petWeight.createMany({
    data: [
      { petId: pet.id, measuredAt: new Date("2025-06-03"), weightLb: 2.7 },
      { petId: pet.id, measuredAt: new Date("2025-06-06"), weightLb: 3.1 },
      { petId: pet.id, measuredAt: new Date("2025-08-22"), weightLb: 6.0 },
    ],
  });
