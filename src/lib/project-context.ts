// Builds a plain-text snapshot of a project's full state — kind-specific
// records (vehicle service, pet health), open todos, recent notes, and
// attachments. Shared by the project chat (/api/projects/[id]/ask) and the
// project-coach cron, which both feed it to Claude as grounding context.
